  ...
  return (
    <div className='w-full overflow-hidden'>
      ...
      {step === 1 && !isNotFirstEntered ?
        <ToolTip position='bottom' content='아이콘과 검색기능을 통해 원하는 학습 신청이 가능해요!'>
          <Category />
        </ToolTip> :
        <Category />
      }
      ...
      {step === 2 && !isNotFirstEntered ?  
        <ToolTip position='bottom' content='뭘 배울지 모르겠다면, 올래에서 가장 인기 많은 교육을 배워보는 건 어때요?'>
      ...
      {step === 4 && !isNotFirstEntered ? 
        <ToolTip position='top' content='전문적으로 배워보고 싶은 게 있다면, 우리 동네 인기 선생님들에게 배울 수도 있어요!'>
          <Teacher />
        </ToolTip> :
        <Teacher />
      }
