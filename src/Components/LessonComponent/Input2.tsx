...
const LeassonInput2 = ({ iconSrc, label, value }: InfoItemProps) => (
  <div className="w-full h-[102px] bg-[#FFFFFF] rounded-2xl border-[1px] border-gray-100 p-6 gap-4 shadow-lg flex mb-6">
